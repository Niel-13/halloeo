...
<head>
    <meta charset="UTF-8">
    {{-- VIEWPORT HARUS PALING AWAL agar browser tidak menunggu --}}
    ...
    <meta property="og:image" content="https://halloeo.com/images/logohalloeo.png">
    ...
    {{-- ── Google Fonts: satu request, kedua family sekaligus ── --}}
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    {{-- FIX: Gabungkan dua link Google Fonts menjadi SATU request & pakai display=swap --}}
    <link rel="preload" as="style"
          href="https://fonts.googleapis.com/css2?family=Outfit:wght@400;500;600;700&family=Playfair+Display:ital,wght@0,600;0,700;1,600&display=swap"
    ...
    {{-- ── Font Awesome: load ASYNC agar tidak memblokir render ── --}}
    {{-- FIX: Gunakan teknik print→all untuk non-blocking load --}}
    <link rel="preload" as="style"
    ...
    {{-- ── Slot untuk preload hero image dari halaman child ── --}}
    @stack('preload')

    {{-- ── Google Analytics (async, tidak memblokir render) ── --}}
    ...
    :root {
        ...
        --dark:        #1E2B38;
        --dark-mid:    #2C3E50;
        --muted:       #556677; /* FIX contrast: dari #6B7C8E → #556677 (ratio >4.5:1 on white) */
        --light:       #F5F7FA;
        --white:       #FFFFFF;
        --surface:     #FAFBFC;
