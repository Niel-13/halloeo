...
<head>
    ...
    <title>500 - Terjadi Kesalahan Server | HalloEO</title>
    ...
    <style>
        * {
        ...
        .error-icon {
            font-size: 8rem;
            background: linear-gradient(135deg, var(--dark-pastel-red), #C67373);
...
<body>
    <div class="error-container">
        ...
        <p class="error-message">
            Maaf, terjadi kesalahan di server kami. Tim teknis kami sudah diberitahu 
        ...
        <div class="help-text">
            <p>
                ...
                dan beritahukan apa yang sedang Anda lakukan.
            </p>
        </div>
    </div>
</body>
