...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | HalloEO</title>
...
<body>
    <div class="error-container">
        ...
        <p class="error-message">
            ...
            Tapi jangan khawatir, kami siap membantu Anda menemukan jalan kembali!
        </p>
        ...
        <div class="quick-links">
            ...
            <div class="quick-links-grid">
                ...
                <a href="{{ route('portfolio.index') }}" class="quick-link">
